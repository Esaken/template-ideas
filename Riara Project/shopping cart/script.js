...
let productsDB = [
  ...
  let primaryColorsBoxSpans = document.querySelectorAll(
      ...
      <div class="product-box">
        ...
        <div class="action-box">
          <button onclick="addToCart(${
            item.id
          })">Add To <i class='bx bx-cart bx-tada'></i></button>
        </div>
        <!-- Product Info -->
        <div class="product-info">
          ...
          <div class="deatils-info">
            ...
            <div class="color-info">
              ...
              <div class="color-type" style="background-color: ${
                item.color
              };"></div>
            </div>
          </div>
    ...
    let inCartProducts = inCartStorageData.map((item) => {
      ...
      <div class="inCart-product">
        ...
        <div class="quantity-box">
          <span class="btn" onclick="increaseProductQty(${
            item.id
          })"><i class='bx bxs-up-arrow'></i></span> <!-- Button Increase -->
          <span>${item.qty}</span> <!-- Quantity Count -->
          <span class="btn ${
            item.qty === 0 ? "disabled" : ""
          }" onclick="decreaseProductQty(${
        item.id
      })"><i class='bx bxs-down-arrow'></i></span> <!-- Button Decrease -->
        </div>
  ...
  function addToCart(id) {
    ...
    let isInCart = inCartProductsData.find(
  ...
  function increaseProductQty(id) {
    ...
    inCartTargetProduct.cost =
      inCartTargetProduct.cost + inCartTargetProduct.price;
    ...
    if (totalPriceStorage) {
      ...
      if (operation === "increase") {
        ...
        localStorage.setItem(
          "totalPrice",
          totalPriceStorage + targetProduct.price
        );
      } else {
        // Else [ Decrease ]
  ...
  (setTotalPrice = function () {
    // Get The Total Price From Local Storage
    let allTotalPrice = localStorage.getItem("totalPrice")
  ...
  function searchToProduct() {
    ...
    let choseenProduct = products.filter(
      (item) =>
        item.title.toLowerCase().indexOf(inputSearchDom.value.toLowerCase()) !==
        -1
    );
  ...
  (function changePrimary() {
    ...
    primaryColorsBoxSpans.forEach((span) => {
      ...
      span.addEventListener("click", function (event) {
        ...
        document
          .querySelectorAll(".primary-area .active")
          .forEach((activeSpan) => {
